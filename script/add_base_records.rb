...
def prod_create(sku, upc, brand, descr, qty_desc, min_qty_weight, image, 
  ...
  Product.create(sku: sku, upc: upc, brand: brand, descr: descr,  #descr: descr + "(#{$load_no})", 
    ...
    category: category, sub_category: sub_category, sub_category_group: sub_category_group, 
    uofm: uofm, price: price, sale_price: sale_price, on_sale: on_sale)  
    $load_no += 1
end
...
# Category: Meat
# ***********************************************************
#           sku,           upc,           brand,                  descr,                                 qty_desc,   min_qty_weight, image,             category,    sub_category, sub_category_group, uofm,     price,   sale_price, on_sale
# ***** Sub-category: Beef ************************
prod_create('10000010101', '10000010101', '',                     'Beef & Pork - Meatloaf Mix',          'per lb',   1.6,            'meat/MeBf01.jpg', 'Meat',     'Beef',        'Cheap',            'lb',      3.99,    3.99,      false)
prod_create('10000010102', '10000010102', 'Busch\'s',             'Ground Beef - Chuck',                 'per lb',   1.2,            'meat/MeBf02.jpg', 'Meat',     'Beef',        'Cheap',            'lb',      3.59,    3.29,      true)
prod_create('10000010103', '10000010103', '',                     'Premium Usda Choice - Filet Mignon',  'per lb',   0.8,            'meat/MeBf03.jpg', 'Meat',     'Beef',        'Premium',          'lb',     24.99,   24.49,      false)
# ***** Sub-category: Breakfast *******************
prod_create('10000010201', '10000010201', 'Alexander & Hornung',  'Bacon - Pepper',                      '24 oz',    0.0,            'meat/MeBr01.jpg', 'Meat',     'Breakfast',   '',                 'each',   11.99,   11.99,      false)
prod_create('10000010202', '10000010202', 'Bob Evans',            'Pork Sausage - Maple Patties',        '12 oz',    0.0,            'meat/MeBr02.jpg', 'Meat',     'Breakfast',   '',                 'each',    4.49,    4.29,      true)
prod_create('10000010203', '10000010203', 'Dearborn',             'Canadian Style Bacon - Chub',         'per lb',   1.0,            'meat/MeBr03.jpg', 'Meat',     'Breakfast',   '',                 'lb',      6.49,    6.49,      false)
# ***** Sub-category: Poultry *********************
prod_create('10000010301', '10000010301', 'Farm Fresh',           'Chicken - Boneless Skinless Breast',  'per lb',   1.5,            'meat/MePo01.jpg', 'Meat',     'Poultry',     'Regular',          'lb',      2.99,    2.99,      true)
prod_create('10000010302', '10000010302', 'Jennie-o',             'Breakfast Sausages - Turkey Links',   '12 oz',    0.0,            'meat/MePo02.jpg', 'Meat',     'Poultry',     'Ground',           'each',    3.99,    3.99,      false)
prod_create('10000010303', '10000010303', 'Jennie-o',             'Marinated Tenderloin - Chipotle Bbq', '24 oz',    0.0,            'meat/MePo03.jpg', 'Meat',     'Poultry',     'Regular',          'each',    8.99,    8.99,      false)
  
# ***********************************************************
# Category: Produce
# ***********************************************************
# ***** Sub-category: Bulk Foods ******************
prod_create('10000020101', '10000020101', '',                     'Almonds - Chocolate',                 'per lb',   0.5,            'prod/PrBf01.jpg', 'Produce',  'Bulk Foods',  'Chocolate',        'lb',      7.49,    7.49,      false)
prod_create('10000020102', '10000020102', '',                     'Bridge Mix - Chocolate',              'per lb',   0.7,            'prod/PrBf02.jpg', 'Produce',  'Bulk Foods',  'Chocolate',        'lb',      5.99,    5.99,      false)
prod_create('10000020103', '10000020103', '',                     'Bulk Mix - Country',                  'per lb',   1.2,            'prod/PrBf03.jpg', 'Produce',  'Bulk Foods',  'Country',          'lb',      3.49,    3.49,      false)
# ***** Sub-category: Fruit ***********************
prod_create('10000020201', '10000020201', '',                     'Apples - Fuji',                       'per lb',   0.5,            'prod/PrFr01.jpg', 'Produce',  'Fruit',       'Apples',           'lb',      1.99,    1.99,      false)
prod_create('10000020202', '10000020202', 'Dole',                 'Bananas',                             'per lb',   0.4,            'prod/PrFr02.jpg', 'Produce',  'Fruit',       'Bananas',          'lb',      0.59,    0.59,      false)
prod_create('10000020203', '10000020203', '',                     'Mangos',                              '1 ea',     0.0,            'prod/PrFr03.jpg', 'Produce',  'Fruit',       '',                 'each',    1.00,    1.00,      true)
# ***** Sub-category: Vegetables ******************
prod_create('10000020301', '10000020301', '',                     'Beans - Green',                       'per lb',   0.0,            'prod/PrVe01.jpg', 'Produce',  'Vegetables',  'Raw',              'lb',      1.29,    1.29,      true)
prod_create('10000020302', '10000020302', 'Busch\'s',             'Fresh Salsa',                         '12 oz',    0.0,            'prod/PrVe02.jpg', 'Produce',  'Vegetables',  'Made',             'each',    2.99,    2.99,      true)
prod_create('10000020303', '10000020303', 'Earthbound',           'Farm Salad - Half & Half',            '5 oz',     0.0,            'prod/PrVe03.jpg', 'Produce',  'Vegetables',  'Raw',              'each',    3.99,    3.99,      false)

# ***********************************************************
# Category: Dairy
# ***********************************************************
# ***** Sub-category: Cheese *********************
prod_create('10000030101', '10000030101', 'Dairy Fresh ',         'Individual Wrap Cheese - American 8 Oz','8 oz',   0.0,            'dair/DrCh01.jpg', 'Dairy',    'Cheese',      'Cheap',            'each',    2.19,    2.19,      false)
prod_create('10000030102', '10000030102', 'Kraft',                'Chunk Cheese - Colby',                '8 oz',     0.0,            'dair/DrCh02.jpg', 'Dairy',    'Cheese',      'Medium Price',     'each',    4.79,    4.79,      false)
prod_create('10000030103', '10000030103', 'Kraft',                'Shredded Cheese - Cheddar Fat Free',  '7 oz',     0.0,            'dair/DrCh03.jpg', 'Dairy',    'Cheese',      'Medium Price',     'each',    3.49,    3.49,      false)
# ***** Sub-category: Eggs *********************
prod_create('10000030201', '10000030201', 'Egg Beaters',          'Original',                            '16 oz',    0.0,            'dair/DrEg01.jpg', 'Dairy',    'Eggs',        'Small',            'each',    3.29,    3.29,      false)
prod_create('10000030202', '10000030202', 'Egglands Best',        'Eggs - Cage Free Grade A Brown',      '12 cnt',   0.0,            'dair/DrEg02.jpg', 'Dairy',    'Eggs',        'Small',            'each',    3.99,    3.99,      false)
prod_create('10000030203', '10000030203', 'Organic Valley',       'Eggs - Extra Large',                  '6 cnt',    0.0,            'dair/DrEg03.jpg', 'Dairy',    'Eggs',        'Large',            'each',    3.69,    3.69,      false)
# ***** Sub-category: Milk *********************
prod_create('10000030301', '10000030301', 'Almond Breeze',        'Milk - Original',                     '64 oz',    0.0,            'dair/DrMi01.jpg', 'Dairy',    'Milk',        'Milk',             'each',    3.99,    3.99,      false)
prod_create('10000030302', '10000030302', 'Coffee Mate',          'Half & Half - Hazelnut',              '32 oz',    0.0,            'dair/DrMi02.jpg', 'Dairy',    'Milk',        'Cream',            'each',    4.49,    4.49,      false)
prod_create('10000030303', '10000030303', 'Dairy Fresh',          'Whipped Cream - Light',               '7 oz',     0.0,            'dair/DrMi03.jpg', 'Dairy',    'Milk',        'Cream',            'each',    2.85,    2.85,      false)
...
customer_id_bo = Customer.find_by_email("bo.diddley@gmail.com").id
...
CustomerShoppingList.create(customer_id: customer_id_bo, shopping_list_name: "Only")
...
customer_shopping_list_id_bo_on = CustomerShoppingList.find_by_customer_id_and_shopping_list_name(customer_id_bo, "Only").id
